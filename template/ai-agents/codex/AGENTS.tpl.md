...
<!-- @include: ../../docs/rules/general.md level=+1 -->

<!-- @include: ../../docs/rules/docs.md level=+1 -->

<!-- @include: ../../docs/rules/git.md level=+1 -->

<!-- @include: ../../docs/rules/go.md level=+1 -->

<!-- @include: ../../docs/rules/go-test.md level=+1 -->
